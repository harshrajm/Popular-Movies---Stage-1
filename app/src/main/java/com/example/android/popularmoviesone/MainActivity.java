...
public class MainActivity extends AppCompatActivity implements MoviesAdapter.ListItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Log.v("key",key);
        Log.v("httpQueryTopRated",httpQueryTopRated);*/
    ...
    public void onListItemClicked(int clickedItemIndex) {
        //Toast.makeText(getApplicationContext(),listOfMovies.get(clickedItemIndex).toString(), Toast.LENGTH_LONG).show();
    ...
    public class MoviesQuery extends AsyncTask<String, Void, ArrayList<Movies>> {
        ...
        protected void onPostExecute(ArrayList<Movies> movies) {
            ...
            //Log.v("size", String.valueOf(movies.size()));
